...
//param ESTRUCTURA DE DATOS:
    //*emisor = Nombre del emisor NO SE MODIFICA
        //*VALORES: TRÁFICO, AÉREO, MAQUINARIA, FIESTA, BOCINA, ANIMAL, SERVICIOS, OTROS
    //*molestia = Nivel de molestia moda registrado
        //*VALORES: Poco, Bastante, Mucho
    //*reportes = Número de reportes totales recibidos
    //*pico = Nivel de ruido más alto registrado
    //*prop = Pomedio de ruido registrado
        //* CALCULO: niveles en db registrados / número de reportes
    //*horario = Horario en el que se registró el ruido
        //*VALORES: Día, Noche
    //*alcaldia = Alcaldía en la que se registró Mmayoritariamente el emisor
    //*texto = Descripción del emisor. NO SE MODIFICAN
