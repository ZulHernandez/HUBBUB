            ...
            <div class="col-1">
                ...
                <div id="opcion2" class="textoDivNavIna navIcon" onclick="scrollMe(2);" onmouseover="navIzqOpa(2, 1);" onmouseleave="navIzqOpa(2, 0);">
                    ...
                    <svg class="navIzqIcon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
                        <path id="icon2" class="st0" d="M12.8,26.4c-0.3,0-0.6-0.1-0.9-0.2c-0.5-0.2-0.9-0.6-1.2-1l-3.9-5H5c-0.7,0-1.4-0.3-1.9-0.8s-0.8-1.2-0.8-1.9
                    ...
                    <div id="textOpc2" class="textNavIzq" style="padding-top: 5px;">Clasificación</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Legislación del ruido-->
                <div id="opcion3" class="textoDivNavIna navIcon" onclick="scrollMe(3);" onmouseover="navIzqOpa(3, 1);" onmouseleave="navIzqOpa(3, 0);">
                    <svg class="navIzqIcon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
                        <g>
                            <path id="icon3" class="st0" d="M13.8,16.6c0-2.9,0-5.9,0-8.8c0-0.2-0.1-0.3-0.3-0.2c-0.6,0-1.2,0-1.8,0c-0.2,0-0.3,0-0.4,0.1
                    ...
                    <div id="textOpc3" class="textNavIzq" style="padding-top: 5px;">Legislación</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Componentes del ruido-->
                <div id="opcion4" class="textoDivNavIna navIcon" onclick="scrollMe(4);" onmouseover="navIzqOpa(4, 1);" onmouseleave="navIzqOpa(4, 0);">
                    <svg class="navIzqIcon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path id="icon4" d="M13.6922 15.3838L13.6922 15.3838L13.6988 15.4075C14.4829 18.1952 15.2504 20.9242 16.2919 22.957C17.3355 24.9939 18.6771 26.375 20.625 26.375C24.1304 26.375 25.887 23.6036 26.7645 20.8362C27.6438 18.0628 27.6625 15.2347 27.6625 15C27.6625 14.931 27.6065 14.875 27.5375 14.875H25.0375C24.9685 14.875 24.9125 14.931 24.9125 15L24.9125 15.0007L24.9125 15.0025L24.9124 15.0087L24.9121 15.0305C24.9117 15.0491 24.9112 15.0755 24.9102 15.1093C24.9084 15.1767 24.9051 15.2735 24.8994 15.3953C24.888 15.6388 24.8669 15.9824 24.8283 16.3924C24.7509 17.2128 24.6033 18.2967 24.3228 19.3764C24.0418 20.4577 23.6298 21.5251 23.0288 22.3197C22.4304 23.111 21.6507 23.625 20.625 23.625C20.2173 23.625 19.8068 23.3383 19.3954 22.7945C18.9875 22.2553 18.6001 21.4912 18.2344 20.5994C17.5128 18.84 16.8873 16.6143 16.3538 14.7158L16.3329 14.6412C15.5464 11.8388 14.7713 9.09393 13.7205 7.05065C12.6707 5.00915 11.3229 3.625 9.375 3.625C5.88791 3.625 4.1409 6.39703 3.26829 9.16397C2.39365 11.9373 2.375 14.7653 2.375 15C2.375 15.069 2.43096 15.125 2.5 15.125H5C5.06904 15.125 5.125 15.069 5.125 15V15C5.125 14.9999 5.125 14.9992 5.12502 14.9977L5.1251 14.9916L5.1255 14.9698C5.12588 14.9512 5.12651 14.9248 5.12752 14.8911C5.12954 14.8236 5.13306 14.7268 5.13903 14.605C5.15099 14.3614 5.17278 14.0178 5.21212 13.6078C5.29085 12.7873 5.43962 11.7033 5.71944 10.6235C5.99971 9.54205 6.40906 8.47446 7.00379 7.67978C7.59617 6.88823 8.36565 6.375 9.375 6.375C9.78441 6.375 10.1927 6.65145 10.6005 7.17881C11.0055 7.70252 11.3899 8.44839 11.7548 9.32909C12.4842 11.0896 13.1228 13.3568 13.6922 15.3838Z" fill="#333333" stroke="#333333" stroke-width="0" stroke-linejoin="round" />
                    </svg>
                    <div id="textOpc4" class="textNavIzq" style="padding-top: 5px;">Componentes</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Efectos en la salud-->
                <div id="opcion5" class="textoDivNavIna navIcon" onclick="scrollMe(5);" onmouseover="navIzqOpa(5, 1);" onmouseleave="navIzqOpa(5, 0);">
                    <svg class="navIzqIcon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
                        <path id="icon5" class="st0" d="M18.8,29h-7.5c-0.7,0-1.4-0.3-1.9-0.8c-0.5-0.5-0.8-1.2-0.8-1.9v-4.8H3.8c-0.7,0-1.4-0.3-1.9-0.8
                    ...
                    <div id="textOpc5" class="textNavIzq" style="padding-top: 5px;">Salud</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Como se mide el ruido-->
                <div id="opcion6" class="textoDivNavIna navIcon" onclick="scrollMe(6);" onmouseover="navIzqOpa(6, 1);" onmouseleave="navIzqOpa(6, 0);">
                    <svg class="navIzqIcon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path id="icon6" d="M26.25 26.375H26.375V26.25V22.625H28.75H28.875V22.5V18.75V18.625H28.75H21.25H21.125V18.75V22.5V22.625H21.25H23.625V26.25V26.375H23.75H26.25ZM6.25 26.375H6.375V26.25V22.625H8.75H8.875V22.5V18.75V18.625H8.75H1.25H1.125V18.75V22.5V22.625H1.25H3.625V26.25V26.375H3.75H6.25ZM13.75 3.625H13.625V3.75V7.375H11.25H11.125V7.5V11.25V11.375H11.25H18.75H18.875V11.25V7.5V7.375H18.75H16.375V3.75V3.625H16.25H13.75ZM13.75 13.625H13.625V13.75V26.25V26.375H13.75H16.25H16.375V26.25V13.75V13.625H16.25H13.75ZM3.625 16.25V16.375H3.75H6.25H6.375V16.25V3.75V3.625H6.25H3.75H3.625V3.75V16.25ZM23.625 16.25V16.375H23.75H26.25H26.375V16.25V3.75V3.625H26.25H23.75H23.625V3.75V16.25Z" fill="#333333" stroke="#333333" stroke-width="0" />
                    </svg>
                    <div id="textOpc6" class="textNavIzq" style="padding-top: 5px;">Medición</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Áreas de estudio-->
                <div id="opcion7" class="textoDivNavIna navIcon" onclick="scrollMe(7);" onmouseover="navIzqOpa(7, 1);" onmouseleave="navIzqOpa(7, 0);">
                    <svg class="navIzqIcon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
                        <path id="icon7" class="st0" d="M15,28.8C15,28.8,15,28.7,15,28.8C15,28.8,15,28.8,15,28.8c-0.2,0-0.5-0.1-0.7-0.2L3.8,22.3
                    ...
                    <div id="textOpc7" class="textNavIzq" style="padding-top: 5px;">Estudio</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Artículos de HUBBUB-->
                <div id="opcion8" class="textoDivNavIna navIcon" onclick="scrollMe(8);" onmouseover="navIzqOpa(8, 1);" onmouseleave="navIzqOpa(8, 0);">
                    <svg class="navIzqIcon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path id="icon8" d="M26.25 27.6377C26.319 27.6377 26.375 27.5817 26.375 27.5127V25.0127C26.375 24.9437 26.319 24.8877 26.25 24.8877H7.51665C7.24016 24.8803 6.95512 24.8216 6.74141 24.6598C6.534 24.5027 6.375 24.2341 6.375 23.7627C6.375 23.6443 6.38551 23.5396 6.40282 23.4447C6.46614 23.1205 6.62699 22.927 6.824 22.8096C7.02573 22.6894 7.27445 22.6438 7.51532 22.6377H25C25.0319 22.6377 25.0576 22.6294 25.0673 22.6264C25.0689 22.6259 25.0703 22.6255 25.0713 22.6252H26.25C26.319 22.6252 26.375 22.5692 26.375 22.5002V5.0127C26.375 3.56491 25.1978 2.3877 23.75 2.3877H7.5C6.72209 2.3877 5.75617 2.64456 4.98205 3.25801C4.20343 3.87503 3.625 4.84844 3.625 6.2627V23.7627C3.625 25.177 4.20343 26.1504 4.98205 26.7674C5.75617 27.3808 6.72209 27.6377 7.5 27.6377H26.25ZM7.50169 5.1377H16.125V13.7627C16.125 13.806 16.1474 13.8463 16.1843 13.869C16.2211 13.8918 16.2672 13.8939 16.3059 13.8745L18.75 12.6525L21.1941 13.8745C21.2328 13.8939 21.2789 13.8918 21.3157 13.869C21.3526 13.8463 21.375 13.806 21.375 13.7627V5.1377H23.625V19.8877H6.375V6.2627C6.375 5.79062 6.53407 5.52184 6.73986 5.36491C6.95177 5.2033 7.23304 5.14507 7.50169 5.1377Z" fill="#333333" stroke="#333333" stroke-width="0" stroke-linejoin="round" />
                    </svg>
                    <div id="textOpc8" class="textNavIzq" style="padding-top: 5px;">Artículos</div>
                </div>
            </div>
            <div class="col-1">
                <!--//* Icono y texto de Referencias y artículos-->
                <div id="opcion9" class="textoDivNavIna navIcon" onclick="scrollMe(9);" onmouseover="navIzqOpa(9, 1);" onmouseleave="navIzqOpa(9, 0);">
                    <svg class="navIzqIcon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve">
                        <path id="icon9" class="st0" d="M12.5,27.3c-2.3,0-4.4-0.9-6-2.5C4.9,23.2,4,21,4,18.8c0-2.3,0.9-4.4,2.5-6l8-8.2c1.2-1.1,2.7-1.7,4.2-1.7
                    ...
                    <div id="textOpc9" class="textNavIzq" style="padding-top: 5px;">Referencias</div>
                </div>
            </div>
            <div class="col-1"></div>
        </div>
